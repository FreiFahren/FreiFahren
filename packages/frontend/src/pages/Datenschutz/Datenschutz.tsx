    ...
    return (
        <>
            <div className='legal-text'>
                ...
                <ul>
                    <li><strong>Einwilligung</strong> (Art. 6 Abs. 1 lit. a DSGVO): Die Nutzer unserer App geben ihre ausdrückliche Einwilligung zur Verarbeitung ihrer personenbezogenen Daten für spezifische Zwecke. Diese Einwilligung kann jederzeit widerrufen werden, wobei der Widerruf die Rechtmäßigkeit der aufgrund der Einwilligung bis zum Widerruf erfolgten Verarbeitung nicht berührt.</li>
                    <li><strong>Vertragserfüllung und vorvertragliche Anfragen</strong> (Art. 6 Abs. 1 lit. b DSGVO): Die Verarbeitung ist notwendig zur Erfüllung eines Vertrags, dessen Vertragspartei die betroffene Person ist, oder zur Durchführung vorvertraglicher Maßnahmen, die auf Anfrage der betroffenen Person erfolgen.</li>
                    <li><strong>Berechtigte Interessen</strong> (Art. 6 Abs. 1 lit. f DSGVO): Die Verarbeitung ist zur Wahrung der berechtigten Interessen des Verantwortlichen oder eines Dritten erforderlich, sofern nicht die Interessen oder Grundrechte und Grundfreiheiten der betroffenen Person, die den Schutz personenbezogener Daten erfordern, überwiegen.</li>
                </ul>
                <p>Die spezifischen Zwecke der Datenverarbeitung sind in den vorangegangenen Abschnitten dieser Datenschutzerklärung detailliert beschrieben. Nutzer können detaillierte Informationen zu ihren Rechten und Möglichkeiten zur Verwaltung ihrer Daten in den folgenden Abschnitten finden.</p>
                <h2>1. Präambel</h2>
                <p>
                    ...
                    Ebenfalls werden Meldungen durch das nicht deterministisch und annoymisierte auswerten der Nachrichten des Freifahren_BE Telegram Gruppe.
                </p>
