...
export default function AutocompleteInputForm(
    props: AutocompleteInputFormProps
) {
    const colourStyles = setStyles(
        props.isIndicatorSeparator,
        props.isDropdownIndicator
    );
