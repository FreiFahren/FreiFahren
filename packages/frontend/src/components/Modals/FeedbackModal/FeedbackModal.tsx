...
const FeedbackModal: React.FC<FeedbackModalProps> = ({
    ...
    return (
        <div className={`feedback-modal modal container ${openAnimationClass}`}>
            ...
            <ul>
                <li>
                    <img
                        ...
                        src={
                            process.env.PUBLIC_URL + '/icons/profiles/joff.jpeg'
                        }
                    ...
                    <div>
                        ...
                        <a
                            href="https://github.com/jfsalzmann"
                            target="_blank"
                ...
                <li>
                    ...
                    <div>
                        <a
                            href="https://github.com/brandesdavid"
                            target="_blank"
                            rel="noopener noreferrer"
                        >
                            <img src={github_icon} alt="github icon" />
            ...
            <h2>Über uns</h2>
            <p>
                FreiFahren ist ein nicht-kommerzielles Open-Source-Projekt, das
                sich zum Ziel gesetzt hat, den Zugang zum öffentlichen
                Nahverkehr zu erleichtern. Wir sind stets offen für neue
                Mithelfende auf unserem GitHub.
            </p>
            <p>
                Ein Großteil der Meldungen stammt aus der{' '}
                <a href="https://t.me/freifahren_BE">
                    FreiFahren_BE Telegram-Gruppe
                </a>
                . Vielen Dank an die Admins, dass wir mit unserem Telegram Bot
                die relevanten Informationen extrahieren dürfen.
            </p>
        </div>
    );
};
