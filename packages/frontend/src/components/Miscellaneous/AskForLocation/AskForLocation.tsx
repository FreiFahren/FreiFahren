...
import AutocompleteInputForm, {
    selectOption,
} from '../../Form/AutocompleteInputForm/AutocompleteInputForm';
...
const AskForLocation: React.FC<AskForLocationProps> = ({
    className,
    setUserPosition,
    children,
    closeModal,
    ...
    const handleSubmit = (event: React.FormEvent) => {
        ...
        if (stationInput.value) {
            const station =
                StationsList[stationInput.value as keyof typeof StationsList];
            if (station) {
                setUserPosition({
            ...
            <form onSubmit={handleSubmit}>
                ...
                <AutocompleteInputForm
                    ...
                    onChange={(value, action) =>
                        handleStationChange(value as selectOption, action)
                    }
                />
