    ...
    <>
      ...
      {areLayerOptionsVisible && (
            <div className='layer-options small-button align-child-on-line'>
              <div>
                <img src={process.env.PUBLIC_URL + '/icons/risk.png'} alt='Showing how the risk layer looks like'></img>
                <p>Risiko</p>
              </div>
              <div>
                <img src={process.env.PUBLIC_URL + '/icons/lines.png'} alt='Showing how the line layer looks like'></img>
                <p>Linien</p>
              </div>
            </div>
      )}
