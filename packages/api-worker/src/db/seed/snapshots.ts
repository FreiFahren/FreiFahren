...
// Reads the city-namespaced bundled snapshots from disk. For the Node/tsx seed CLI only — the
// Workers test runtime has no filesystem and injects a bundled-import loader instead.
