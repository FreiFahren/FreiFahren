...
// @Summary Get all stations (v1)
// @Description Retrieves information about all available stations for API version v1.
// @Tags stations-v1
// @Produce json
...
// @Summary Get a single station by ID (v1)
// @Description Retrieves information about a specific station based on its ID for API version v1.
// @Tags stations-v1
// @Produce json
...
// @Router /v1/stations/{stationId} [get]
...
// @Summary Search for a station by name (v1)
// @Description Searches for a station using the provided name for API version v1.
// @Tags stations-v1
// @Produce json
