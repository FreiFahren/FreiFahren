...
export function ReportForm() {
  ...
  const { stationId: initialStationId, lineId: initialLineId } = routeApi.useSearch();
  ...
  return (
    <ReportSelectionProvider initialStationId={initialStationId} initialLineId={initialLineId}>
